...
namespace Coffee_nhomChungMinh.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class Coffee_nhomChungMinhModule : ModuleBase {
    public Coffee_nhomChungMinhModule() {
		// 
		// Coffee_nhomChungMinhModule
		// 
